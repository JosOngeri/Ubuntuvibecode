...
const OwnerKpi = () => {
  ...
  return (
    <div className="p-6">
      <h1 className="text-3xl font-bold text-gray-800 mb-6">KPI Overview</h1>
            ...
            <tbody className="divide-y divide-gray-200">
              {kpi.map((k) => (
                <tr key={k.id} className="hover:bg-gray-50">
                  <td className="px-6 py-4">{k.employeeName || '-'}</td>
                  <td className="px-6 py-4">{k.definitionTitle}</td>
                  <td className="px-6 py-4">{k.score || '-'}</td>
