    ...
    <DashboardLayout>
      <div className="mb-8">
        ...
        <div className="mt-2 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
          <p className="text-sm text-blue-700 dark:text-blue-300">{getEvaluationInfo()}</p>
        </div>
      </div>
            ...
            {employees.map(employee => (
              <option key={employee.id || employee._id} value={employee.id || employee._id}>
                {employee.firstName
                  ...
                  : employee.email || `Employee ${employee.id}`}
              </option>
            ))}
          </select>
        ...
        <div className="bg-white dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-700 p-6">
          ...
          {employeeKPIs.length === 0 ? (
            <div className="text-center py-12">
              <p className="text-slate-500 dark:text-slate-400">No KPIs found for this employee</p>
            </div>
          ) : (
