    ...
    },
    {
      ...
      render: (_, row) => (
        <div className="flex gap-2 items-center">
          ...
          <button
            className="p-1.5 bg-amber-100 text-amber-600 hover:bg-amber-200 rounded dark:bg-amber-900/30 dark:text-amber-400 transition"
            title="Edit User"
            onClick={() => {
              setEditUser(row);
              setEditData({
          ...
          <button
            className="p-1.5 bg-purple-100 text-purple-600 hover:bg-purple-200 rounded dark:bg-purple-900/30 dark:text-purple-400 transition"
          ...
          {row.status !== 'active' && (
            <button
              className="p-1.5 bg-green-100 text-green-600 hover:bg-green-200 rounded dark:bg-green-900/30 dark:text-green-400 transition"
              title="Approve User"
              onClick={() => {
                setApproveUser(row);
          ...
          <button
            className="p-1.5 bg-red-100 text-red-600 hover:bg-red-200 rounded dark:bg-red-900/30 dark:text-red-400 transition"
            title="Delete User"
  ...
  const handleExportUsersReport = async () => {
    await downloadPdfReport({
      ...
      columns: [
        ...
        {
          label: 'Created At',
          getValue: row => (row.createdAt ? new Date(row.createdAt).toLocaleDateString() : ''),
        },
      ],
      metadata: [
    ...
    <div>
      ...
      <Card>
        <div className="flex flex-wrap items-end gap-3 mb-4">
          ...
          <Button type="button" variant="outline" onClick={handleExportUsersReport}>
            Export Report
          </Button>
        </div>
        <Table
      ...
      >
        <form onSubmit={handleApprove} className="space-y-4">
          <div>
            ...
            <Input
              value={approveDetails.wageRate}
              onChange={e => setApproveDetails({ ...approveDetails, wageRate: e.target.value })}
              required
            />
          </div>
          <div>
            ...
            <Input
              value={approveDetails.department}
              onChange={e => setApproveDetails({ ...approveDetails, department: e.target.value })}
              required
            />
          </div>
          <div className="flex gap-2 mt-4">
