        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white dark:bg-ubuntu-brown-light rounded-xl shadow-lg border border-ubuntu-tan dark:border-ubuntu-sienna p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-xl font-semibold text-ubuntu-brown dark:text-ubuntu-cream">
                Account
              </h2>
            </div>
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-ubuntu-brown-dark dark:text-ubuntu-tan mb-2">
                  Username
                </label>
                <input
                  type="text"
          ...
          <div className="bg-white dark:bg-ubuntu-brown-light rounded-xl shadow-lg border border-ubuntu-tan dark:border-ubuntu-sienna p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <label className="text-sm font-medium text-ubuntu-brown-dark dark:text-ubuntu-tan">
                  Dark Mode
                </label>
                <button
          ...
          <div className="bg-white dark:bg-ubuntu-brown-light rounded-xl shadow-lg border border-ubuntu-tan dark:border-ubuntu-sienna p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <span className="text-sm font-medium text-ubuntu-brown-dark dark:text-ubuntu-tan">
                  Version
                </span>
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm text-ubuntu-brown dark:text-ubuntu-tan">
                  Today at 2:30 PM
                </span>
              </div>
