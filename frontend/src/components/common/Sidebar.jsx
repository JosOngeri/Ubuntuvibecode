...
const Sidebar = ({ isOpen, onClose, isCollapsed, onToggleCollapse }) => {
      ...
      return [
        {
          title: 'Dashboard',
          priority: 1,
          items: [{ path: '/admin/dashboard', label: 'Dashboard', icon: BsSpeedometer2 }],
        },
        {
          title: 'People',
          priority: 2,
          items: [{ path: '/admin/people', label: 'People', icon: BsPeople }],
        },
        {
          title: 'Attendance',
          priority: 3,
          items: [{ path: '/admin/attendance', label: 'Attendance', icon: BsClipboardCheck }],
        },
        {
          title: 'Payroll',
          priority: 4,
          items: [{ path: '/admin/payroll', label: 'Payroll', icon: BsCreditCard }],
        },
        {
          title: 'Performance',
          priority: 5,
        ...
        },
        {
          title: 'Contracts',
          priority: 6,
          items: [{ path: '/admin/contracts', label: 'Contracts', icon: BsFileEarmarkText }],
        },
        {
          title: 'HR Operations',
          priority: 7,
        ...
        },
        {
          ...
          priority: 10,
          items: [{ path: '/messages', label: 'Messages', icon: BsChatDots }],
        },
        {
          title: 'Settings',
          priority: 11,
          items: [{ path: '/admin/settings', label: 'Settings', icon: BsGear }],
        },
      ];
      ...
      return [
        {
          title: 'Dashboard',
          priority: 1,
          items: [{ path: '/manager/dashboard', label: 'Dashboard', icon: BsSpeedometer2 }],
        },
        {
          title: 'People',
          priority: 2,
        ...
        },
        {
          title: 'Attendance',
          priority: 3,
          items: [{ path: '/manager/attendance', label: 'Attendance', icon: BsClipboardCheck }],
        },
        {
          title: 'Performance',
          priority: 4,
          items: [{ path: '/kpi/manage', label: 'Performance', icon: BsGraphUp }],
        },
        {
          title: 'Contracts',
          priority: 5,
        ...
        },
        {
          title: 'Reports',
          priority: 8,
          items: [{ path: '/admin/reports', label: 'Reports', icon: BsGraphUp }],
        },
        {
          title: 'Hiring',
          priority: 9,
      ...
      return [
        {
          title: 'Dashboard',
          priority: 1,
          items: [{ path: '/employee/dashboard', label: 'Dashboard', icon: BsSpeedometer2 }],
        },
        {
          title: 'Attendance',
          priority: 2,
        ...
        },
        {
          title: 'Payroll',
          priority: 3,
          items: [{ path: '/payroll/payslips', label: 'My Payslips', icon: BsFileText }],
        },
        {
          title: 'Performance',
          priority: 4,
          items: [{ path: '/kpi/my-goals', label: 'My Goals', icon: BsBullseye }],
        },
        {
          title: 'Complaints',
          priority: 5,
          items: [{ path: '/admin/complaints', label: 'Complaints', icon: BsHandThumbsUp }],
        },
        {
          title: 'Jobs',
          priority: 6,
      ...
      return [
        {
          title: 'Overview',
          priority: 1,
          items: [{ path: '/contractor/dashboard', label: 'Dashboard', icon: BsSpeedometer2 }],
        },
        {
          title: 'Projects',
          priority: 2,
          items: [{ path: '/contractor/projects', label: 'Projects', icon: BsBriefcase }],
        },
        {
          title: 'Milestones',
          priority: 3,
          items: [{ path: '/contractor/portal', label: 'Submit Milestones', icon: BsCloudUpload }],
        },
        {
          title: 'Invoices',
          priority: 4,
          items: [{ path: '/contractor/invoices', label: 'Invoices', icon: BsFileEarmarkText }],
        },
        {
          title: 'KPIs',
          priority: 5,
          items: [{ path: '/contractor/reports', label: 'My KPI', icon: BsGraphUp }],
        },
        {
          title: 'Communications',
          priority: 6,
      ...
      return [
        {
          title: 'Overview',
          priority: 1,
          items: [{ path: '/daily-labour/dashboard', label: 'Dashboard', icon: BsSpeedometer2 }],
        },
        {
          title: 'Attendance',
          priority: 2,
        ...
        },
        {
          title: 'Payments',
          priority: 3,
          items: [{ path: '/daily-labour/payments', label: 'Payments', icon: BsFileText }],
        },
        {
          title: 'Communications',
          priority: 4,
    ...
    return [
      {
        title: 'Overview',
        priority: 1,
        items: [{ path: '/dashboard', label: 'Dashboard', icon: BsSpeedometer2 }],
      },
    ];
  };
  ...
  return (
    <>
      ...
      <aside
        className={`fixed lg:static left-0 top-16 h-[calc(100vh-64px)] ${isCollapsed ? 'w-20' : 'w-64'} bg-[#1a1a2e] border-r border-slate-800 transform transition-all duration-300 z-40 flex flex-col ${isOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}`}
      >
        {/* User Profile at top */}
        {!isCollapsed && (
          <NavLink
