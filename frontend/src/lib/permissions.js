...
export const ROLE_HIERARCHY = {
  owner: 100, admin: 90, manager: 80,
  department_head: 70, supervisor: 60,
  employee: 50, daily_labourer: 40, contractor: 30
}
...
export const ALL_PERMISSIONS = Object.values(PERMISSION_GROUPS)
  .reduce((acc, group) => ({ ...acc, ...group.permissions }), {})
...
export const DATA_SCOPE = {
  ALL: 'all', DEPARTMENT: 'department',
  TEAM: 'team', SELF: 'self', NONE: 'none'
}

export const ROLE_DATA_SCOPE = {
  owner: DATA_SCOPE.ALL, admin: DATA_SCOPE.ALL,
  manager: DATA_SCOPE.ALL, department_head: DATA_SCOPE.DEPARTMENT,
  supervisor: DATA_SCOPE.TEAM, employee: DATA_SCOPE.SELF,
  daily_labourer: DATA_SCOPE.SELF, contractor: DATA_SCOPE.SELF
}
...
export const DEFAULT_ROLE_PERMISSIONS = {
  ...
  manager: [
    ...
    'send_messages', 'resolve_complaints', 'view_audit_logs'
  ],
  department_head: [
  ...
  employee: [
    'view_employees', 'view_attendance', 'mark_attendance_self',
    'view_leaves', 'request_leave', 'view_leave_balance',
    'view_kpis', 'self_assessment', 'view_own_payroll', 'send_messages'
  ],
  daily_labourer: [
    'view_attendance', 'mark_attendance_self',
    'view_own_payroll', 'send_messages', 'resolve_complaints'
  ],
  contractor: [
    'view_attendance', 'view_own_payroll', 'send_messages'
  ]
}
...
export default {
  BASE_ROLES, ADDITIONAL_ROLES, ALL_ROLES, ROLE_HIERARCHY,
  PERMISSION_GROUPS, ALL_PERMISSIONS, DURATION_TYPES,
  DEFAULT_DURATION, DURATION_LIMITS, DATA_SCOPE, ROLE_DATA_SCOPE,
  DEFAULT_ROLE_PERMISSIONS, hasPermission, canAccessPage,
  getDataScope, canDelete, canGrantPermission, calculateExpiryDate,
  getEffectivePermissions, formatPermissionLabel
}
