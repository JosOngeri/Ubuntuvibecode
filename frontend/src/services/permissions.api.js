...
export const permissionsAPI = {
  ...
  updateRolePermissions: (role, permissions) => api.put(`/permissions/role/${role}`, { permissions }),
}
...
export const supervisorAPI = {
  ...
  // Delete allocation
  deleteAllocation: (id, reason) => api.delete(`/supervisor-allocations/${id}`, { data: { reason } }),
...
export const auditAPI = {
  ...
  getEntityLogs: (entityType, entityId, params) => api.get(`/audit/entity/${entityType}/${entityId}`, { params }),
